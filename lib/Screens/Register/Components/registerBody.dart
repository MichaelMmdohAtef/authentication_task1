                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (text){
                            name=text.toString();
                            var map=convertToMap(name:name,pass: password,email: email);

                            firestore.collection(collection).doc(uid).set(map).then((value){

                              print("userName changed successfully");
                            });
                            // TODO: add your code to add User userName in firestore
                          },
                        ),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (text){
                            email=text.toString();
                            var map=convertToMap(email: email,pass: password, name: name);
                            firestore.collection(collection).doc(uid).set(map).then((value){
                              print("userName changed successfully");
                            });
                            //TODO:
                           //add your code to add the user email in firestore
                          },
                        ),
                      ),
                    ),
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (text){
                            ...
                            var map=convertToMap(pass: password,name:name,email: email);
                            firestore.collection(collection).doc(uid).set(map).then((value){
                              print("userName changed successfully");
                            });
